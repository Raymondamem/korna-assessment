  ...
  return (
    <div className="w-full h-fit py-8">
      {Articles.map((article) => (
        <div key={article} className="w-full h-fit mb-4 border-b-1 border-gray-200 py-4">
          <div className="w-full h-fit flex justify-between items-stretch gap-4">
            <div className="w-5/6 h-fit">
              ...
              <p className="font-bold text-[1.5rem]  mb-4">
              ...
              <span className="block w-fit h-fit font-light text-md text-gray-700">
                It's not just a publishing platform. It's a community.
              </span>
            </div>
